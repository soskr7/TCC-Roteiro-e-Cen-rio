...
<section class="navArea">
  ...
  <section class="SecaoLogin">
    ...
    <div class="main-block">
      <center><h2 id="cadas">CADASTRO</h2></center>
      <!--
  ...
  <form id="formulario" method="post" action="registro.php">
        ...
        <hr>
        <center>
        <input type="text" name="usuario" id="usuario" placeholder="Insira o nome de usuário:" onkeydown="validacaoEmail()" required/>
        ...
        <p><a href="login.php" id="ntconta"><font color="#1c87c9">Já tem uma conta? Clique aqui e faça Login!</font><a>
        <hr></p>
...
<div class="error-msg">
  <p id=sla>
  <font color="#1c87c9">Usuario já cadastrado!</font>
</p>
 </div>
...
<?php
  ...
  <div class="error-msg">
  <p id=sla>
  <font color="#1c87c9">Email já cadastrado!</font>
</p>
 </div>
...
<script src="https://vlibras.gov.br/app/vlibras-plugin.js"></script>
  <script>
    ...
    function validacaoEmail() {
          ...
          var email = document.getElementById("formulario").value;
          var form = document.getElementById("formulario");
          var pattern = /^[^ ]+@[^ ]+\.[a-z]{2,3}$/;
          ...
          if(email.match(pattern)) {
                ...
                text.style.color = "#fb2c3e";


          }else
          form.classList.remove("válido");
                form.classList.add("iinválido");

                text.innerHTML = "Por favor insira um email válido"
                text.style.color = "#fb2c3e";      

    }
   if(email == "") form.classList.remove("válido");
                form.classList.add("iinválido");
